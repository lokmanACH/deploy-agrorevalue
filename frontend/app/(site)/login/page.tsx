...
//   );
// }
// >>>>>>> 7c4ae4f16b020d5e6174fe6a28d2f408803daa65
"use client";
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center px-4">
      ...
      <button
        ...
        className="fixed bottom-3 right-3 z-20 text-[12px] px-2 py-1 rounded border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-800"
      >
