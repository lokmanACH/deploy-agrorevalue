    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden">
        ...
        <div className="px-7 pt-7 pb-5 border-b border-zinc-200 dark:border-zinc-800">
          <Image src={logo} alt="Logo" className="w-auto h-12 mb-4" />
      ...
      <button
        ...
        className="fixed bottom-3 right-3 z-20 text-[12px] px-2 py-1 rounded border border-zinc-200 dark:border-zinc-700 bg-emerald-600 dark:bg-emerald-900 text-white hover:bg-emerald-700 dark:hover:bg-emerald-800"
      >
        Cliquez pour tester avec des comptes pré-remplis
      </button>

      {devOpen && (
        <div className="fixed bottom-12 right-3 z-20 p-3 font-mono">
